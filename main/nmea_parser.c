...
/* Provide a sensible default if the Kconfig option is not defined */
...
/* Provide sensible defaults if the Kconfig options are not defined */
...
#if CONFIG_NMEA_STATEMENT_GGA || CONFIG_NMEA_STATEMENT_RMC || CONFIG_NMEA_STATEMENT_GLL
/**
